 ...
 * @property string $usuario_clave write-only password
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return static::findOne(['usuario_id' => $usuario_id, 'status' => self::STATUS_ACTIVE]);
    }
    ...
    {
        return static::findOne(['usuario_nombre' => $usuario_nombre, 'status' => self::STATUS_ACTIVE]);
    }
