...
<div class="form-group">
    <?= $form->field($model, "conductor_nombre")->input("text")?>
</div>
<div class="form-group">
    <?= $form->field($model, "conductor_dni")->input("text")?>
</div>
<div class="form-group">
    <?= $form->field($model, "conductor_telefono")->input("text")?>
</div>
<div class="form-group">
    <?= $form->field($model, "conductor_vigencia_licencia")->widget(DatePicker::className(), [
